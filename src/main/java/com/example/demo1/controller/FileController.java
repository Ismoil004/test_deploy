...
public class FileController {
    private static final String UPLOAD_DIR = "demo1/files/e_video/";
    private static final String IMAGE_UPLOAD_DIR = "demo1/files/resors/";
    private static final String UPLOAD_DIRS = "demo1/files/e_tour/";
...
public void getVideo(@RequestParam String name, HttpServletRequest request, HttpServletResponse response) throws IOException {
    File videoFile = new File("demo1/files/e_video/" + name);
    if (!videoFile.exists()) {
